...
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> emps) {
        //1.创建一个 Excel 文档
        ...
        for (int i=0; i<emps.size(); i++) {
            ...
            row.createCell(22).setCellValue(emp.getWorkState());
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 12:
                                        ...
                                        break;
                                    case 13:
                                        int deptIndex = allDepartments.indexOf(new Department(cellValue));
                                        employee.setDepartmentId(allDepartments.get(deptIndex).getId());
                                        break;
                                    case 14:
